...
public class PersonalSettingsController {
    ...
    protected void formBackingObject(HttpServletRequest request,Model model) {
        ...
        command.setPodcastIndexEnabled(userSettings.isPodcastIndexEnabled());
        ...
        command.setAutoBookmark(userSettings.isAutoBookmark());
    ...
    protected String doSubmitAction(@ModelAttribute("command") PersonalSettingsCommand command, RedirectAttributes redirectAttributes) {
        ...
        settings.setPodcastIndexEnabled(command.isPodcastIndexEnabled());
