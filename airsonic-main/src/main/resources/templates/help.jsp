...
<table width="75%" class="ruleTable indent">
    ...
    <tr><td class="ruleTableHeader"><fmt:message key="help.version.title"/></td><td class="ruleTableCell">${versionString} &ndash; ${buildDateString} [Commit: <a href="https://github.com/kagemomiji/airsonic-advanced/commit/${model.buildNumber}" target="_blank">${model.buildNumber}</a>]</td></tr>
